    ...
    (() => {
        ...
        let bodyLock = (delay = 500) => {
            ...
            if (bodyLockStatus) {
                ...
                header.style.paddingRight = window.innerWidth - document.querySelector(".header").offsetWidth + "px";
        ...
        function handleFiles(files) {
            const totalFiles = fileList.children.length + files.length;
            if (totalFiles > maxFiles) {
                showMessage("Максимальна кількість файлів - 5");
                return;
            }
            ...
            for (const file of files) {
                if (file.size > maxFileSize) {
                    ...
                    showMessage(`Файл ${file.name} перевищує максимальний розмір 5 МБ`);
                    continue;
                }
                ...
                fileName.innerText = filenameWithoutExtension.length > 8 ? filenameWithoutExtension.substring(0, 8) + "..." : filenameWithoutExtension;
                fileName.innerText += "." + fileExtension;
